      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Adicione uma ou mais URLs de vídeos do YouTube para fazer o
            download. Nossa ferramenta processa seus vídeos de forma rápida e
            segura.
          </p>
        </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
              ...
              <div className="text-blue-800 text-xs mt-1">
                Adicione várias URLs de uma só vez
              </div>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
              ...
              <div className="text-green-800 text-xs mt-1">
                Downloads otimizados e seguros
              </div>
            </div>
